...
boy = createSprite(displayWidth/2,displayHeight-30,20,20);
...
function draw() {
  ...
  fill(255);
    textSize(50);
    textFont("gregorian");
  text("Treasure: "+ treasureCollection,displayWidth/2,50);
  }
...
function createCash() {
  ...
  cash.scale=0.21;
  cash.velocityY = 3;
  cash.lifetime = Math.round(displayHeight/3);
  cashG.add(cash);
  }
}
...
function createDiamonds() {
  ...
  diamonds.lifetime = Math.round(displayHeight/3);
...
function createJwellery() {
  ...
  jwellery.lifetime = (Math.round(displayHeight/3));
...
function createSword(){
  ...
  sword.scale=0.16;
  sword.velocityY = 3;
  sword.lifetime = (Math.round(displayHeight/3));
